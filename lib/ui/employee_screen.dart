...
@override
  void initState() {
    ...
    super.initState();
      ...
      _ageController = new TextEditingController(text: widget.employee.fullName);
      _nameController = new TextEditingController(text: widget.employee.adresse);
                ...
                child: (widget.employee.id != null) ? Text(
                 ...
                 onPressed: () {
                  if(widget.employee.id != null){
                    db.updateEmployee2(Employee.fromMap({
                      'id' : widget.employee.id,
                      'fullName' : _nameController.text,
                      'adresse' : _ageController.text,
